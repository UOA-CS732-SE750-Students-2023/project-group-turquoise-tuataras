                    ...
                    <a href={`/recipes/${recipe.id}`}
                       style={{textDecoration: 'none', color: 'black', textAlign: "center", width: "100%"}}>
                        <Card className={style.card_group_card} key={recipe.id} style={{margin: "auto"}}>
                            ...
                            <Card.Body>
                                <Card.Title
                                    style={{position: "relative", top: "5px", fontSize: "16px", textAlign: "left"}}>
        ...
        <div>
            <Form>
                ...
                <InputGroup className="mb-3 container">
                    ...
                    <Form.Control style={{marginLeft: "20px", borderRadius: "5px 0 0 5px"}}
                                  aria-label="Complex Search Bar" defaultValue={query}/>
                    <Button style={{width: "150px"}} variant="outline-secondary" id="button-addon2"
